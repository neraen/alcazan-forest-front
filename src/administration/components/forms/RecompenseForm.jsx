    ...
    render(){
        return (
            <div className="action-container">
                ...
                <Field name="argent" value={this.props.questMaker.sequences[this.props.sequenceIndex].recompense.money} onChange={this.handleChange} label="Argent"/>
                <Field name="experience" value={this.props.questMaker.sequences[this.props.sequenceIndex].recompense.experience} onChange={this.handleChange} label="Experience"/>
                <Field name="quantity" value={this.props.questMaker.sequences[this.props.sequenceIndex].recompense.quantity} onChange={this.handleChange} label="quantity"/>

                <Select name="objet" onChange={this.handleChange} label="Objet">
                ...
                <Select name="equipement" onChange={this.handleChange} label="Equipement">
                ...
                <Select name="consommable" onChange={this.handleChange} label="Consommable">
